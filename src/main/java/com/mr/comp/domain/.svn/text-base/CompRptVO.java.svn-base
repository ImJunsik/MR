...
public class CompRptVO extends Domain {
    private int mrReqNo;
    ...
    private int mrReqCompNo;
    private int invstCost;
    private int invstBudget;
    private String trialRst;
    private String postMngPlan;
    private String compleReq;
    private String techEmpNm;
    private String capexClose;

    private String mrTotalPeriod;
    private String mrReqDate;
    private String mrInvDate;
    private String mrSafeDate;
    private String mrCompDate;
    ...
    public int getMrReqCompNo() {
        return mrReqCompNo;
    }

    public void setMrReqCompNo(int mrReqCompNo) {
        this.mrReqCompNo = mrReqCompNo;
    }

    public int getInvstCost() {
        return invstCost;
    }

    public void setInvstCost(int invstCost) {
        this.invstCost = invstCost;
    }

    public int getInvstBudget() {
        return invstBudget;
    }

    public void setInvstBudget(int invstBudget) {
        this.invstBudget = invstBudget;
    }

    public String getTrialRst() {
        return trialRst;
    }

    public void setTrialRst(String trialRst) {
        this.trialRst = trialRst;
    }

    public String getPostMngPlan() {
        return postMngPlan;
    }

    public void setPostMngPlan(String postMngPlan) {
        this.postMngPlan = postMngPlan;
    }

    public String getCompleReq() {
        return compleReq;
    }

    public void setCompleReq(String compleReq) {
        this.compleReq = compleReq;
    }

    public String getTechEmpNm() {
        return techEmpNm;
    }

    public void setTechEmpNm(String techEmpNm) {
        this.techEmpNm = techEmpNm;
    }

    public String getCapexClose() {
        return capexClose;
    }

    public void setCapexClose(String capexClose) {
        this.capexClose = capexClose;
    }
    ...
    public String getMrTotalPeriod() {
        return mrTotalPeriod;
    }

    public void setMrTotalPeriod(String mrTotalPeriod) {
        this.mrTotalPeriod = mrTotalPeriod;
    }
    ...
    public void setMrReqDate(String mrReqDate) {
        this.mrReqDate = mrReqDate;
    }

    public String getMrInvDate() {
        return mrInvDate;
    }

    public void setMrInvDate(String mrInvDate) {
        this.mrInvDate = mrInvDate;
    }

    public String getMrSafeDate() {
        return mrSafeDate;
    }

    public void setMrSafeDate(String mrSafeDate) {
        this.mrSafeDate = mrSafeDate;
    }

    public String getMrCompDate() {
        return mrCompDate;
    }

    public void setMrCompDate(String mrCompDate) {
        this.mrCompDate = mrCompDate;
    }
