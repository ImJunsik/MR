...
public class CompFileVO extends Domain {
    private int mrReqNo;
    ...
    private String chrgrDiv;

    private List<MrRvRstVO> rvRsts;
    private List<CompChrgrChgHistVO> appLine;
    ...
    public List<CompChrgrChgHistVO> getAppLine() {
        return appLine;
    }

    public void setAppLine(List<CompChrgrChgHistVO> appLine) {
    ...
    public String getChrgrDiv() {
        return chrgrDiv;
    }

    public void setChrgrDiv(String chrgrDiv) {
        this.chrgrDiv = chrgrDiv;
    }
