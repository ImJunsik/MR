...
public class JobsReviewDao extends BaseSqlMapRepository{
    ...
    public MrRvRstVO selectMrHazopExe(int mrReqNo) {
        return selectOne("mr.jobs.selectMrHazopExe", mrReqNo);
    }
     ...
     * @return
     */
    public int updateMrHazopExe(MrRvRstVO mrRvRstVO) {
        return update("mr.jobs.updateMrHazopExe", mrRvRstVO);
    }
     ...
     * @return
     */
    public int insertMrHazopExe(MrRvRstVO mrRvRstVO) {
        return insert("mr.jobs.insertMrHazopExe", mrRvRstVO);
    }
    ...
    public JobsCheckMasterVO selectMrCheckExe(Integer mrReqNo, String mrStepCd) {
        ...
        params.put("mrReqNo", mrReqNo);
        params.put("mrStepCd", mrStepCd);
        return selectOne("mr.jobs.selectMrCheckExe", params);
    }
     ...
     * @return
     */
    public int insertMrCheckExe(JobsCheckMasterVO jobsCheckMasterVO) {
        return insert("mr.jobs.insertMrCheckExe", jobsCheckMasterVO);
    }
     ...
     * @return
     */
    public int updateMrCheckExe(JobsCheckMasterVO jobsCheckMasterVO) {
        return update("mr.jobs.updateMrCheckExe", jobsCheckMasterVO);
    }
