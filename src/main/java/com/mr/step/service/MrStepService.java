...
public interface MrStepService{
     ...
     * @return
     */
    String selectMrInvstCost(int mrReqNo);
    ...
    /**
     * 신규 Step과 결재라인 생성(여러명) 담당자 지정 시 오류 처리)
     * @param mrReqNo
     * @param mrStepCd
     * @param procStCd
     * @param chrgrChgHist
    ...
    int insertMrStep2(int mrReqNo, String mrStepCd, String procStCd, List<ChrgrChgHist> appLine);
    ...
    void updateTechEmp(int mrReqNo, int mrReqProcStepNo, String mrStepCd, String procStCd, List<ChrgrChgHist> techEmps);
     ...
     * @param techEmps
     */
    void insertCompEmp(int mrReqNo, int mrReqProcStepNo, String mrStepCd, String procStCd, List<ChrgrChgHist> techEmps);
     ...
     * @param procStCd
     * @param chrgrChgHist
     * yoo 리턴 메소드로 변경 20240104
     */
     ChrgrChgHist insertMrStepSingleAction(int mrReqNo, String mrStepCd, String procStCd, String chrgrClCd);

     /**
      *  MR_REQ_PROC_STEP의 PK로 저장 메소드 - yoo 240103
      * 1. MR_REQ_PROC_STEP의 PK의 중복 저장을 막기 위해  기존 PK를 사용
      * @param mrReqNo
      * @param mrStepCd
      * @param procStCd
      * @param chrgrChgHist
      * * yoo 리턴 메소드로 변경 20240104
      */
     int insertMrStepSingleAction(int mrReqNo, String currentMrStepCd, String nextProcStCd, String chrgrClCd, String mrStepCd, ChrgrChgHist chrgrChgHist2D);
     ...
     */
    int insertMrStepMultiAction(int mrReqNo, String mrStepCd, String procStCd, List<ChrgrChgHist> appLine, String lastAppChrgrClCd, int mrReqProcStepNo);

    /*
     * Insert 해야 할지 판단 체크
     */
    List<MrReqProcStepVO> checkInsertMrStep(int mrReqNo, String mrStepCd,String chrgrClCd);
    ...
    //yoo 240411 MR완료 처리 용
    void updateMrStep3(int mrReqNo, String currentMrStepCd, String nextProcStCd, String nextChrgrClCd, String getMrStepCd, String getChrgrClCd);
    /**
     * 결재라인 수정 (결재진행중)
     * @param mrReqNo
     * @param appLine
     ...
     * @param procStCd
     */
    String insertNextAppEmp(int mrReqNo, String nextProcStCd);
     ...
     * @param procStCd
     */
    String updateDetHistDelDuplication(int mrReqNo, String stepCd, String loginEmpNo);
    
    /**
     * Step과 다음 결재 진행 yoo 240920 다음 스텝으로 저장이 안되고 현재로 저장이 되는 문제를 해결위해 생성
     * @param mrReqNo
     * @param procStCd
     */
    void insertNextAppEmp2(int mrReqNo, String nextProcStCd);
    
    
    /**
     * Step과 다음 결재 진행 yoo 240926 insertNextAppEmp와 insertNextAppEmp3의 차이는 중복 제거 기능이 있느냐 없느냐의 차이다
     * @param mrReqNo
     * @param procStCd
     */
    String insertNextAppEmp3(int mrReqNo, String nextProcStCd);
    
    //yoo 20210617
    void insertNextAppEmpDev(int mrReqNo, String nextProcStCd);
	...
	/**
	 * 변경된 기술검토담당자 정보를 업데이트 한다.
	 * @param mrReqTechEmpInfo
	 */
	void updateChrgrChgHist(ChrgrChgHist mrReqTechEmpInfo);
	 ...
	 */
	void updateMrReqProcStepDet(MrReqProcStepDetVO actMrReqProcStepDet);
	void insertMrReqProcStepDet(MrReqProcStepDetVO actMrReqProcStepDet);
	void insertMrReqProcStepDetDev(MrReqProcStepDetVO actMrReqProcStepDet);
     ...
     * @param mrStepCd
     */
    /*void updateAppLineDelExe(int mrReqNo, String mrStepCd);*/
}
