...
public class MrAprvIfGwController extends BaseController {
    ...
    ****************************************************************************************************************/
    ...
    public String appAgreeReturn_Z0030_Z0110(TechInvestVO techInvestVO, HashMap paramMap, Model model) {
    	logger.info("appAgreeReturn_Z0030_Z0110");
    	String connStatGubun = paramMap.get("connStatGubun").toString();
    	String ret = "01";
    ...
    public String appAgreeReturn_Z0030_Z0122(TechReviewVO techReviewVO, HashMap paramMap, Model model) {
    	logger.info("appAgreeReturn_Z0030_Z0122 : " + techReviewVO.getMrReqNo());
    	List<ChrgrChgHist> appInfoList = mrStepRepository.selectAppStepEmpMulti(techReviewVO.getMrReqNo());
        
    	String connStatGubun = paramMap.get("connStatGubun").toString();
    	String ret = "01";

    	logger.info("reqno: getMrReqNo - " + techReviewVO.getMrReqNo());
    	logger.info("타당성검토 승인 connStatGubun 04면 승인, 05면 반려 => " + connStatGubun);
    	logger.info("appInfoList.size() : " + appInfoList.size());
    ...
    public String appAgreeReturn_Z0090(CompRptVO compRptVO, HashMap paramMap, Model model) {
    	...
    	logger.info("JEWOOK connStatGubun jewook  : " + connStatGubun);
        try{
    ...
    ****************************************************************************************************************/
    ...
    public MRrqRegisterVO mrAprvInit_Z0010(HashMap paramMap, Model model) {
    	...
    	logger.info(getInterfaceFile() + " - mrAprvInit_Z0010");
    ...
    public TechInvestVO mrAprvInit_Z0030_Z0110(HashMap paramMap, Model model) {
    	...
    	logger.info(getInterfaceFile() + " - mrAprvInit_Z0030_Z0110");
    ...
    public TechReviewVO mrAprvInit_Z0030_Z0122(HashMap paramMap, Model model) {    	
    	...
    	logger.info(getInterfaceFile() + " - mrAprvInit_Z0030_Z0122");
    ...
    public CompRptVO mrAprvInit_Z0090(HashMap paramMap, Model model) {
    	...
    	logger.info(getInterfaceFile() + " - mrAprvInit_Z0090");
    ...
    private static String htmlBody_Z0010(MRrqRegisterVO mRrqRegisterVO) {
		...
		sb.append("<TD style='BORDER-BOTTOM: black 1px solid; TEXT-ALIGN: left; BORDER-LEFT: black 1px solid; PADDING-LEFT: 5px; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid' colSpan=3><a href='http://mr.oilbank.co.kr/mr/mrRqRegister.do?mrReqNo=" + mRrqRegisterVO.getMrReqNo()+ "'>"+ mRrqRegisterVO.getMrReqTitle() +"</a></TD></TR>");
		sb.append("<TR>");
    ...
    private static String htmlBody_Z0030_Z0110(TechInvestVO techInvestVO) {
		...
		sb.append("<TR>");
		sb.append("<TD style='BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid'>사업명</TD>");
		sb.append("<TD style='BORDER-BOTTOM: black 1px solid; TEXT-ALIGN: left; BORDER-LEFT: black 1px solid; PADDING-LEFT: 5px; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid' colSpan=5><a href='http://mr.oilbank.co.kr/mr/mrTechInvest.do?mrReqNo=" + techInvestVO.getMrReqNo()+ "'>" +techInvestVO.getMrReqTitle()+ "</a></TD></TR>");
		sb.append("<TR>");
		sb.append("<TD style='BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid'>개선대상</TD>");
    ...
    private static String htmlBody_Z0030_Z0122(TechReviewVO techReviewVO) {
		...
		sb.append("<TD style='BORDER-BOTTOM: black 1px solid; TEXT-ALIGN: left; BORDER-LEFT: black 1px solid; PADDING-LEFT: 5px; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid' colSpan=2><a href='http://mr.oilbank.co.kr/mr/mrComplete.do&mrReqNo="+techReviewVO.getMrReqNo()+"'>"+techReviewVO.getMrReqTitle()+"<a></TD>");
    ...
    private static String htmlBody_Z0090(CompRptVO compRptVO) {
		...
		StringBuffer sb = new StringBuffer();
           sb.append("<TD style='BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid; FONT-SIZE: 12pt; VERTICAL-ALIGN: top; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid' id=body class=FIELD>");
            ...
            sb.append("<TD style='BORDER-BOTTOM: black 1px solid; TEXT-ALIGN: left; BORDER-LEFT: black 1px solid; PADDING-LEFT: 5px; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid' colSpan=5><a href='http://mr.oilbank.co.kr/mr/compRptRegister.do&mrReqNo"+compRptVO.getMrReqNo()+"'>"+compRptVO.getMrReqTitle()+"</TD>");
            ...
            sb.append("<TD style='BORDER-BOTTOM: black 1px solid; TEXT-ALIGN: left; BORDER-LEFT: black 1px solid; PADDING-LEFT: 5px; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid' colSpan=7>"+compRptVO.getInvstCost()+"천원</TD></TR>");
            sb.append("<TR>");
            ...
            sb.append("<TD style='BORDER-BOTTOM: black 1px solid; TEXT-ALIGN: left; BORDER-LEFT: black 1px solid; PADDING-LEFT: 5px; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid' colSpan=7>"+compRptVO.getInvstBudget()+"천원</TD></TR>");
            sb.append("<TR>");
