...
/**
 * Service layer에서 예외가 발생했음을 나타내는 exception 클래스이다.
 * 본 exception 외에 업무적으로 service 단에서 필요한 exception 있을 경우 해당 클래스를 상속받아 구현하도록 한다.
 * 
 * <pre>
 * 수정일 | 수정자 | 수정내용
 * ---------------------------------------------------------------------
...
public class ServiceException extends BaseException {
     ...
     */
    public ServiceException(MessageSource messageSource, String messageKey) {
     ...
     * @param errorCode 예외 코드
     */
    public ServiceException(MessageSource messageSource, String messageKey, int errorCode) {
     ...
     */
    public ServiceException(MessageSource messageSource, String messageKey, Object[] messageParameters) {
     ...
     * @param errorCode 예외 코드
     */
    public ServiceException(MessageSource messageSource, String messageKey, Object[] messageParameters, int errorCode) {
     ...
     * @param cause 이전 예외 클래스
     */
    public ServiceException(MessageSource messageSource, String messageKey, Throwable cause) {
     ...
     * @param errorCode 예외 코드
     */
    public ServiceException(MessageSource messageSource, String messageKey, Throwable cause, int errorCode) {
