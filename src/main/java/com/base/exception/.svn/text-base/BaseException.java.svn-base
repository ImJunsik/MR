...
/**
 * <p>본 프로젝트에서 사용하는 최상위 Exception 클래스로서 업무단에서 필요한 Exception이 있다면
 * 본 클래스를 상속 받거나 또는 업무 프로그램 Layer 성격에 맞는 WebException, ServiceException, RepositoryException 클래스를
 * 상속받아 구현하도록 한다.</p>
 *
 * <p>본 Exception 클래스는 기본적으로 MessageSource를 이용한 exception message 처리가 가능하도록 설계되어 있으므로
 * Exception throw 할 때 exception 내용을 코드내에 hard coding 하지 말고 message resource bundle 사용하도록 한다.</p>
 * 
 * @author 조용상
 * @version 1.0
 * 
...
public class BaseException extends RuntimeException {
    private static final long serialVersionUID = -5710340152711803483L;
     ...
     * @param errorCode 예외 코드
     */
    public BaseException(MessageSource messageSource, String messageKey, int errorCode) {
     ...
     * @param errorCode 예외 코드
     */
    public BaseException(MessageSource messageSource, String messageKey, Object[] messageParameters, int errorCode) {
     ...
     * @param cause 이전 예외 클래스
     */
    public BaseException(MessageSource messageSource, String messageKey, Throwable cause) {
     ...
     * @param errorCode 예외 코드
     */
    public BaseException(MessageSource messageSource, String messageKey, Throwable cause, int errorCode) {
