	           ...
	           <table class="table_pop_default builds">
	               ...
	               <tr>
	                   <td>
	                   		...
	                   		<!-- <span class="vam techText" id="div00Name" name="div00Name">생산부문 / 상무보  / 송규석</span> -->
	                   	
	                   		<c:if test="${jobsPorc.plant == '8700'}">
	                   			<span class="vam techText">생산부문 / 부장 / 유병문</span>	                   			                   			
	                   		</c:if>
	                   		<c:if test="${jobsPorc.plant != '8700'}">
	   						<span id="confirmer" class="vam techText">안전생산본부장 / 부사장 / </span>
					   		</c:if>
	                   </td>
	                   <td class="vat">
                ...
                <tr>
                    ...
                    <td class="vat">
                      <div class="form_group">
                          ...
                          <span class="pl5"><fmt:formatDate value='${drive.rvRsts[0].lastChgDt}' pattern='yyyy-MM-dd HH:mm' /></span>
                          <div class="form_group pt3">
                ...
                <tr>
                    ...
                    <td class="vat">
                      <div class="form_group">
                          ...
                          <span class="pl5" id="div01span${loop.index}" name="div01span${loop.index}" value="<fmt:formatDate value='${tech.rvRsts[0].lastChgDt}' pattern='yyyy-MM-dd HH:mm' />"><fmt:formatDate value='${tech.rvRsts[0].lastChgDt}' pattern='yyyy-MM-dd HH:mm' /></span>
                          <div class="form_group pt3">
                ...
                <tr>
                    ...
                    <td class="vat">
                      <div class="form_group">
                          ...
                          <span class="pl5" id="div05span${loop.index}" name="div05span${loop.index}"><fmt:formatDate value='${build.rvRsts[0].lastChgDt}' pattern='yyyy-MM-dd HH:mm' /></span>
                          <div class="form_group pt3">
                ...
                <tr>
                    ...
                    <td class="vat">
                      <div class="form_group">
                          ...
                          <span class="pl5"><fmt:formatDate value='${check.rvRsts[0].lastChgDt}' pattern='yyyy-MM-dd HH:mm' /></span>
                          <div class="form_group pt3">
                ...
                <tr>
                    ...
                    <td class="vat">
                      <div class="form_group">
                          ...
                          <span class="pl5" id="div04span${loop.index}"><fmt:formatDate value='${safety.rvRsts[0].lastChgDt}' pattern='yyyy-MM-dd HH:mm' /></span>
                          <div class="form_group pt3">
                ...
                <tr>
                    ...
                    <td class="vat">
                      <div class="form_group">
                          ...
                          <span class="pl5"><fmt:formatDate value='${etc.rvRsts[0].lastChgDt}' pattern='yyyy-MM-dd HH:mm' /></span>
                          <div class="form_group pt3">
...
$(window).ready(function() {
    ...
    var criteriaDate = new Date('2021-11-01');
    var approvalDate;
	...
	for(var element in array_pl5)
	{
		...
		if(array_pl5[element].innerText != null)
			if(array_pl5[element].innerText.toString().indexOf('20') == 0)
			{
				...
				console.log('criteriaDate < approvalDate : ' + (criteriaDate < approvalDate));
				if(criteriaDate0 > approvalDate)
					bbb = 1;			//'정혜원'
				else if(criteriaDate1 < approvalDate)
					bbb = 3;			//'정임주'
				else if(criteriaDate0 < approvalDate)
					bbb = 2;			//'고영규'
			}
	}
	console.log('arrayDate.length : ' + arrayDate.length);
	if(array_vam.length == 0)
		confirmer = '';
	else if(array_vam.length > (arrayDate.length + 1))
		confirmer = '정임주';
	else if(bbb == 2)
		confirmer = '고영규';
	else if(bbb == 3)
	...
	if(radioTach != $('input[name="div999"]:checked').val()){    	 
    	...
    	if(radioTach > 0){    		
    		...
    		/*
    		var sTime2 = $('#div01span1').text();

    		var approvalDate = new Date(sTime);
    		var approvalDate2 = new Date(sTime2);
    		var criteriaDate = new Date('2021-11-01');
    		
    		console.log('approvalDate : ' + approvalDate);
    		console.log('criteriaDate : ' + criteriaDate);
    		console.log(criteriaDate < approvalDate);
    		console.log(criteriaDate < approvalDate2);
    		if(criteriaDate > approvalDate && criteriaDate > approvalDate2)
    			confirmer = '정해원';
    		else if(criteriaDate < approvalDate || criteriaDate < approvalDate2)
    			confirmer = '고영규';
    		else if(sTime != '' && sTime2 == '')
    			confirmer = '정해원';
    		else if(sTime == '' || sTime2 == '')
    			confirmer = '고영규';
    		else if(sTime == null || sTime2 == null)
    			confirmer = '고영규';
    	*/
    		var hPar =  sTime.substring(11, 13);
      		...
      		//날짜가 있을때
      		if(sPlant!='8700'){
      			$('#div00Name').text('안전생산본부장 / 부사장 / ' + confirmer);
      		}else{
      			if(sTimeDay == null)
      		...
      		if (sTime.length > 1) {
          		...
          		$('#confirmer').text('안전생산본부장 / 부사장 / ' + confirmer);
      		}
    	}
   	}
