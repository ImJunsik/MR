...
<table class="table_pop_row" border="1" cellspacing="0">
    ...
    <div class="form_group">
        ...
        <input type="hidden" id="chrgrClCd" name="chrgrClCd" value="${chrgrClCd}">
...
$(window).ready(function() {
    ...
    if(opener.document.getElementById("reloadAndClose") != null)
    {
    	reloadAndClose += opener.document.getElementById("reloadAndClose").value * 1;
    	opener.document.getElementById("reloadAndClose").value = reloadAndClose;
    }
    
    console.log('reloadAndClose : ' + reloadAndClose);
    //alert('reloadAndClose : ' + reloadAndClose);
    window.onunload = refreshParent;

    function refreshParent() {
    	
    	if((opener.document.getElementById("reloadAndClose").value *1) > 2)
    	{
    ...
    $(".search").click(function(){
        ...
        //reloadAndClose += opener.document.getElementById("reloadAndClose").value * 1;
        //alert(reloadAndClose);
        opener.document.getElementById("reloadAndClose").value = 2;
