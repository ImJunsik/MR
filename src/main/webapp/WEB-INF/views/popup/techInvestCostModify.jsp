...
<div class="pop_button_top">
    <input type="image" src="../images/btn_requestApproval.png" style="display:none" class="vam cursor appReq IAI"/>
    <input type="image" src="../images/btn_approve.png" style="display:none" class="vam cursor app IAC"/>
...
<hr class="divider_none_10" />
    ...
    <table class="table_row" border="1" cellspacing="0">
        ...
        <tbody>         
        <tr>
            <th class="dep2" scope="row">승인자</th>
            <td>
                <div class="form_group">
                <c:if test="${modeClass!='IAI'}"><span class="appText"></span></c:if>
                <c:if test="${modeClass=='IAI'}"><input type="text" class="i_input appText" readOnly/></c:if>
                ...
                <img src="../images/icon_search.png" class="cursor empSearch IAI" data-role="app" style="display:none"/>
                </div>
            </td>
            <th scope="row">승인일</th>
            <td>
               <div class="form_group">
               <c:if test="${modeClass!='IAI'}"><span class="appDate"></span></c:if>
               <c:if test="${modeClass!='IAI'}"><span class="appEndDate"></span></c:if>
               <c:if test="${modeClass=='IAI'}">
                    승인기한 : <input type="text" name="appLine[1].procTrmDt" class="i_input inputDate limitDate appEndDate" value="" readOnly/>(결재중)
               </c:if>
               <c:if test="${modeClass!='IAI'}">
                    <input type="hidden" name="appLine[1].procTrmDt" class="appEndDate" value=""/>
               </c:if>
               </div>
            </td>
        </tr>
    ...
    <tr>
        <td rowspan="7" class="title">
          <c:if test="${loop.index==0 }">
              <c:if test="${modeClass=='IAI'}">
              <select class="startYear IAI" disabled="disabled">
          ...
          <c:if test="${loop.index>0 }">
              ...
              <c:if test="${modeClass=='IAI'}"><img src="../images/btn_del.gif" class="vam cursor delYear" /></c:if>
          </c:if>
        </td>
      ...
      <c:forEach var="investCost" items="${techInvest.investCosts}" >
        <tr>
            ...
            <td class="num">
                ...
                <c:if test="${modeClass!='IAI'}"><fmt:formatNumber value="${investCost.cost01}" groupingUsed="true"/></c:if>
                </div>
            </td>
            <td class="num">
                <div class="form_group">
                ...
                <c:if test="${modeClass!='IAI'}"><fmt:formatNumber value="${investCost.cost02}" groupingUsed="true"/></c:if>
                </div>
            </td>
            <td class="num">
                <div class="form_group">
                ...
                <c:if test="${modeClass!='IAI'}"><fmt:formatNumber value="${investCost.cost03}" groupingUsed="true"/></c:if>
                </div>
            </td>
            <td class="num">
                <div class="form_group">
                ...
                <c:if test="${modeClass!='IAI'}"><fmt:formatNumber value="${investCost.cost04}" groupingUsed="true"/></c:if>
                </div>
            </td>
            <td class="num">
                <div class="form_group">
                ...
                <c:if test="${modeClass!='IAI'}"><fmt:formatNumber value="${investCost.cost05}" groupingUsed="true"/></c:if>
                </div>
            </td>
            <td class="num">
                <div class="form_group">
                ...
                <c:if test="${modeClass!='IAI'}"><fmt:formatNumber value="${investCost.cost06}" groupingUsed="true"/></c:if>
                </div>
            </td>
            <td class="num">
                <div class="form_group">
                ...
                <c:if test="${modeClass!='IAI'}"><fmt:formatNumber value="${investCost.cost07}" groupingUsed="true"/></c:if>
                </div>
            </td>
            <td class="num">
                <div class="form_group">
                ...
                <c:if test="${modeClass!='IAI'}"><fmt:formatNumber value="${investCost.cost08}" groupingUsed="true"/></c:if>
                </div>
            </td>
            <td class="num">
                <div class="form_group">
                ...
                <c:if test="${modeClass!='IAI'}"><fmt:formatNumber value="${investCost.cost09}" groupingUsed="true"/></c:if>
                </div>
            </td>
            <td class="num">
                <div class="form_group">
                ...
                <c:if test="${modeClass!='IAI'}"><fmt:formatNumber value="${investCost.cost10}" groupingUsed="true"/></c:if>
                </div>
            </td>
            <td class="num">
                <div class="form_group">
                ...
                <c:if test="${modeClass!='IAI'}"><fmt:formatNumber value="${investCost.cost11}" groupingUsed="true"/></c:if>
                </div>
            </td>
            <td class="num">
                <div class="form_group">
                ...
                <c:if test="${modeClass!='IAI'}"><fmt:formatNumber value="${investCost.cost12}" groupingUsed="true"/></c:if>
                </div>
            </td>
        </tr>
      </c:forEach>
...
$(window).ready(function() {
    ...
    $(".save").click(function () {
        if(confirm("저장 하시겠습니까?")) {
            ...
            $("form").attr("action", "techInvestCostSave.do").submit();
        }
    });
    ...
    $(".return").click(function () {
        if(confirm("반려 하시겠습니까?")) {
            $.removeComma();
            $('#pageLoadingWrap').show();
            $("form").attr("action", "investCostReturn.do").submit();
        }
    });
