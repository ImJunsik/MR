...
<div class="button_top">
    ...
    <!--<input type="image" src="images/btn_approve.png" style="display:block" class="vam cursor app CCA CEA"/>        승인 주석 처리 (전자결제) -->   
...
<!--     <input type="hidden" class="engValue" name="appLine[0].chrgEmpNo" />
    ...
    <table class="table_row" border="1" cellspacing="0">
        ...
        <tr>
            <th rowspan="6" scope="row">기술 및 타당성검토</th>
        ...
        <tr>
	        <th class="dep2" scope="row">온실가스 배출</th>
	        <td colspan="3">
	            <div class="form_group TECH06_group">
	            <input type="hidden" name="rvRsts[5].itemCd" value="TECH06" />
	            <input type="radio" name="rvRsts[5].clCd01" class="i_radio CDA TECH06" value="1" disabled="disabled"/>있음
	            <input type="radio" name="rvRsts[5].clCd01" class="i_radio CDA TECH06" value="2" disabled="disabled"/>없음
	            <!-- span class="ml30">의견 : <c:if test="${modeClass!='CDA'}"><span class="TECH06_SUGG_text"></span></c:if><input type="text" name="rvRsts[5].totRvSugg" class="i_input_200 BAA TECH06_SUGG" value="" style="display:none"/></span> -->
	            </div>
	        </td>
	    </tr>
        ...
        <tr>
            ...
            <td colspan="3">
            	<div class="form_group">
		    	<c:if test="${modeClass=='CDA'}">
		        	온실가스 배출량 : <input type="text" class="i_input num number" name="zoutqty" id="zoutqty"  value="<fmt:formatNumber value="${techReview.zoutqty}" groupingUsed="true"/>" >&nbsp;tCO2&nbsp;/&nbsp;탄소배출권 비용 : <input type="text" class="i_input num number" id="zoutamt" name="zoutamt" value="<fmt:formatNumber value="${techReview.zoutamt}" groupingUsed="true"/>" >원
		        </c:if>
		        <c:if test="${modeClass!='CDA'}">
		        	온실가스 배출량 : <fmt:formatNumber value="${techReview.zoutqty}" groupingUsed="true"/>&nbsp;tCO2&nbsp;/&nbsp;탄소배출권 비용 : <fmt:formatNumber value="${techReview.zoutamt}" groupingUsed="true"/>원
		        </c:if>
		        </div>
            </tr>
        </tr>
