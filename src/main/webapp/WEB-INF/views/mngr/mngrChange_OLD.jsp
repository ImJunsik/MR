    ...
    <!--     <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <img src="images/icon_search.png" class="cursor empSearch costF" data-role="costC" style="display:none"/>
                <input type="checkbox" class="check" value="true" style="display:none">
                </div>
            </td>
            <td class="costFDate">
        ...
        <tr>
            ...
            <td>
                ...
                <img src="images/icon_search.png" class="cursor empSearch costC" data-role="costF" style="display:none"/>
                <input type="checkbox" class="check" value="true" style="display:none">
                </div>
            </td>
            <td class="costCDate">
        ...
        <tr>
            <th scope="row" rowspan="7">직무검토</th>
        ...
        <tr>
            <th scope="row" class="dep2">환경안전</th>
            <td>
                <div class="form_group">
        ...
        <tr>
            <th scope="row" class="dep2">안전</th>
            <td>
                <div class="form_group">
                <input type="text" class="i_input jobSafetyText" readOnly style="display:none"/>
                <input type="hidden" class="jobSafetyValue value" name="" />
                <input type="hidden" class="jobSafetyDetNo detNo" name=""/>
                <input type="hidden" class="jobSafetyDutyText dutyText" name="" />
                <input type="hidden" class="jobSafetyTeamText teamText" name="" />
                <input type="hidden" class="jobSafetyTeamValue teamValue" name="" />
                <img src="images/icon_search.png" class="cursor empSearch jobSafety" data-role="jobSafety" style="display:none"/>
                <input type="checkbox" class="check" value="true" style="display:none">
                </div>
            </td>
            <td class="jobSafetyDate"></td>
        </tr>
        <tr>
        ...
        <!-- 2021.10.25 MR완료 추가  -->
        <tr>
            <th scope="row" class="dep2" rowspan="3">MR완료</th>
            <th scope="row" class="dep2">문서등록담당자</th>
            <td>
                <div class="form_group">
                <input type="text" class="i_input docText" readOnly style="display:none"/>
                <input type="hidden" class="docValue value" name="" />
                <input type="hidden" class="docDetNo detNo" name=""/>
                <input type="hidden" class="docDutyText dutyText" name="" />
                <input type="hidden" class="docTeamText teamText" name="" />
                <input type="hidden" class="docTeamValue teamValue" name="" />
                <img src="images/icon_search.png" class="cursor empSearch doc" data-role="doc" style="display:none"/>
                <input type="checkbox" class="check" value="true" style="display:none">
                </div>
            </td>
            <td class="docDate">
        		...
        		<tr>
					...
					<td>
						<div class="form_group">
			              <input type="text" class="i_input agreeText" readOnly style="display:none"/>
			              <input type="hidden" class="agreeValue value" name="" />
			              <!-- <input type="hidden" class="empLine0 agreeCode"  name="appLine[0].chrgrClCd" value="Z02Q"/> -->
			              <input type="hidden" class="agreeDetNo detNo  name="appLine[0].chrgrClCd" value="Z02A"/>
			              <input type="hidden" class="agreeDutyText dutyText" name="" />
			              <input type="hidden" class="agreeTeamText teamText" name="" />
			              <input type="hidden" class="agreeTeamValue teamValue" name="" />
			              <img src="images/icon_search.png" class="cursor empSearch agree" data-role="agree" style="display:none"/>
			             <input type="checkbox" class="check" value="true" style="display:none">
			            </div>
					</td>
					<td class="docDate">
        ...
        success : function(data) {
            if(data.list!=null) {
                  $.each(data.list, function() {
                      ...
                      if (this.chrgrClCd.indexOf("Z02Q")>=0) {
                          switch (this.chrgrClCd) {
                          case "Z02Q":
                              target = "doc";
                              break;}
                      }
                      /* if (this.chrgrClCd.indexOf("Z02A")>=0) {
                          switch (this.chrgrClCd) {
                          case "Z02A":
                          	  target ="agree";
                          	  break;
                      ...
                      console.log(this.mrStepCd , this.chrgrClCd , target, this.chrgEmpName);
                      if(target.indexOf("risk")>=0 || (this.chrgrClCd.indexOf("Z02L")<0 && this.chrgrClCd.indexOf("Z02C")<0 &&  this.chrgrClCd.indexOf("Z02G1")<0 && this.chrgrClCd.indexOf("Z02B")<0)) {
                          ...
                          if(this.chrgrClCd.indexOf("Z02G1")<0){
                              target = "appLine";
                          } else if (this.chrgrClCd.indexOf("Z02G1")>=0) {
                              target = "techManager";
                          }
                          var div = "";
                          var date = null;
