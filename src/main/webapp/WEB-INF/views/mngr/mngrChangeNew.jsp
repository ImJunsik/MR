...
<div id="content_header">
    <h4 class="content_header title">MR정보New</h4>
</div>
...
<form id="searchForm" method="post">
    ...
    <div class="button_middle">
        <input id="save" type="image" style="vertical-align:bottom" src="images/btn_save.png">
    </div>
</div>
...
<!--         <tr>
        ...
        <tr>
            ...
            <th scope="row" class="dep2">Job Engineer<br>(기술검토자)</th>
            <td>
                <div class="form_group">
        ...
        <tr>
            ...
            <td>
                <div class="form_group">
                <input type="text" class="i_input techFText" readOnly style="display:none; width:100px;"/>
        ...
        <tr>
            <th scope="row" class="dep2">직책과장</th>
            <td colspan="2">
