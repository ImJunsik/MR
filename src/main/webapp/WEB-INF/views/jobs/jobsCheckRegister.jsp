...
<div class="button_top">
    <c:if test="${subModeClass!='IAD'}"><input type="image" src="images/btn_save.png" style="display:none" class="vam cursor save JAA"/></c:if>
    <c:if test="${isSkip!='TRUE'}"><input type="image" src="images/btn_holdoff.png" style="display:none" class="vam cursor skip JAA"/> </c:if>
    <c:if test="${subModeClass=='IAD' && jobsReview.isJobsComplete}"><input type="image" src="images/btn_complete.png" class="vam cursor appReq"/> </c:if>
    <!-- input type="image" src="images/btn_requestReratingIV.png" style="display:none" class="vam cursor appReq BAA"/-->
    <c:if test="${costModeClass!='IAFF' && (modeClass=='JAA' || modeClass=='JAB')}"><input type="image" src="images/btn_requestReratingIV.png" class="vam cursor costModify"/> </c:if><!-- 투자비산정 -->
...
<input type="hidden" id="mrReqNo" name="mrReqNo" value="<c:out value="${jobsReview.mrReqNo}"/>"/>
    <input type="hidden" id="mrNo" name="mrNo" value="<c:out value="${jobsReview.mrNo}"/>"/>
    <input type="hidden" id="mrStepCd" name="mrStepCd" value="Z0025"/>
    <input type="hidden" id="plantNo" value="<c:out value="${jobsReview.plant}"/>"/>
    
  <!--yoo 20240823 기술검토 승인 프로세스 추가 -->
    <table border="0" cellspacing="0">
			    ...
			    <tbody>
			     <tr>
			        <td>
		              ...
		              <c:if test="${modeClass!='BAA' and modeClass!='BBA'}"><span class="actionText" style="display:none" ></span></c:if>
		              <c:if test="${modeClass=='BAA' or modeClass=='BBA'}"><input type="hidden" class="actionText"/></c:if>
				...
				<c:set var="i" value="1"/>
				<c:forEach var='appLine' items='${jobsReview.jobs}'>
			    <c:set var="i" value="${i+1}"/>
			    <c:if test="${appLine.chrgrClCd == 'Z02G1'}" >
			    <tr>
			        <td>
			            <div class="form_group">
			              <c:if test="${modeClass!='BAA' and modeClass!='BBA'}"><span class="empLine${i}Text"  style="display:none" ></span></c:if>
			              <c:if test="${modeClass=='BAA' or modeClass=='BBA'}"><input type="hidden" class="empLine${i}Text"/></c:if>
			              <input type="hidden" class="empLine${i}Value" name="appLine[${i}].chrgEmpNo" />
			              <input type="hidden" name="appLine[${i}].chrgrClCd" value="Z02G1"/>
			              <input type="hidden" class="empLine${i}DutyText" name="appLine[${i}].thdayPos" />
			              <input type="hidden" class="empLine${i}TeamText" name="appLine[${i}].thdayTeam" />
			              <input type="hidden" class="empLine${i}TeamValue" name="appLine[${i}].chrgTeamNo" />
		              </div>
			        </td>
			    </tr>
			    </c:if>
        ...
        <div class="form_group">
          <table id="fileList" class="table_default_margin" border="1" cellspacing="0">
            ...
            <tr>
               <td>                
                <c:if test="${loop.last}">
                	<input type="hidden" id="multCnt" value ="${loop.index}">
                </c:if>
...
<!-- 
<table class="table_row drive" border="1" cellspacing="0" style="display:block">
    <caption class="blind"></caption>
    <colgroup>
    <col width="15%">
    <col width="15%">
    ...
    <tr style="display:none">
        ...
        <td colspan="3">
            <div class="form_group">
            <input type="text" name="rvRsts[1].clCmt05" class="i_input_full clCmt05" value="" disabled="disabled"/>
            </div>
        </td>
    </tr>
    <tr style="display:none">
        ...
        <td colspan="3">
            <div class="form_group">
            <c:if test="${modeClass=='JAA'}">
            <textarea name="rvRsts[1].totRvSugg" class="i_text_full totRvSugg" rows="" cols="" disabled="disabled"></textarea>
            </c:if>
            <c:if test="${modeClass!='JAA'}">
...
<table class="table_row highPressure" border="1" cellspacing="0" style="display:none">
    ...
    <tr style="display:none">
       <th class="dep2" scope="row">HCP 공유 필요 여부</th>
       <td colspan="3">
           <div class="form_group">
...
<table class="table_row checkFocus" border="1" cellspacing="0" style="display:none">
    <caption class="blind"></caption>
    <colgroup>
    <col width="15%">
    <col width="7%">
    ...
    <tbody>
    <tr class="cursor fold">
        <th rowspan="16" class="dep1" scope="row">검사 관점 <img src="images/icon_s_dropdown.png" class="vam cursor"></th>
        <th colspan="2" class="dep2" scope="row">검토자</th>
        <td>
              <span class="checkText"></span>
              <input type="hidden" class="checkValue" name="jobs[11].chrgEmpNo" />
              <input type="hidden" name="jobs[11].chrgrClCd" value="Z02H2"/>
              <input type="hidden" name="rvRsts[11].chrgrClCd" value="Z02H2"/>
              <input type="hidden" class="checkDutyText" name="jobs[11].thdayPos" />
              <input type="hidden" class="checkTeamText" name="jobs[11].thdayTeam" />
              <input type="hidden" class="checkTeamValue" name="jobs[11].chrgTeamNo" />
              <img src="images/icon_search.png" class="vam cursor empChange" data-role="check" style="display:none"/>
        </td>
        <th class="dep2" scope="row">검토일</th>
        <td><span class="checkDate"></span></td>
    ...
    <tr style="display:none">
        ...
        <td colspan="3">
            <div class="form_group">
            <input type="hidden" name="rvRsts[11].itemCd" class="vam clCmt10" value="JOBS" disabled="disabled"/>
            <input type="radio" name="rvRsts[11].clCd01" class="i_radio clCd01" value="1" disabled="disabled"/>증가
            <input type="radio" name="rvRsts[11].clCd01" class="i_radio clCd01" value="2" disabled="disabled"/>감소
            <input type="radio" name="rvRsts[11].clCd01" class="i_radio clCd01" value="3" disabled="disabled"/>해당없음
            </div>
        </td>
    </tr>
    <tr style="display:none">
        ...
        <td colspan="3">
            <div class="form_group">
            <input type="radio" name="rvRsts[11].clCd02" class="i_radio clCd02" value="1" disabled="disabled"/>증가
            <input type="radio" name="rvRsts[11].clCd02" class="i_radio clCd02" value="2" disabled="disabled"/>감소
            <input type="radio" name="rvRsts[11].clCd02" class="i_radio clCd02" value="3" disabled="disabled"/>해당없음
            </div>
        </td>
    </tr>
    <tr style="display:none">
        ...
        <td colspan="3">
            <div class="form_group">
            <input type="radio" name="rvRsts[11].clCd03" class="i_radio clCd03" value="1" disabled="disabled"/>증가
            <input type="radio" name="rvRsts[11].clCd03" class="i_radio clCd03" value="2" disabled="disabled"/>감소
            <input type="radio" name="rvRsts[11].clCd03" class="i_radio clCd03" value="3" disabled="disabled"/>해당없음
            </div>
        </td>
    </tr>
    <tr style="display:none">
        ...
        <td colspan="3">
            <div class="form_group">
            <input type="radio" name="rvRsts[11].clCd04" class="i_radio clCd04" value="1" disabled="disabled"/>증가
            <input type="radio" name="rvRsts[11].clCd04" class="i_radio clCd04" value="2" disabled="disabled"/>감소
            <input type="radio" name="rvRsts[11].clCd04" class="i_radio clCd04" value="3" disabled="disabled"/>해당없음
            </div>
        </td>
    </tr>
    <tr style="display:none">
        ...
        <td colspan="3">
            <div class="form_group">
	            <input type="radio" name="rvRsts[11].clCd05" class="i_radio clCd05" value="1" disabled="disabled"/>해당없음
	            <input type="radio" name="rvRsts[11].clCd05" class="i_radio clCd05" value="2" disabled="disabled"/>수행필요
            </div>
        </td>
    </tr>
    <tr style="display:none">
        ...
        <td colspan="3">
            <div class="form_group">
	            <input type="radio" name="rvRsts[11].clCd06" class="i_radio clCd06" value="1" disabled="disabled"/>해당없음
	            <input type="radio" name="rvRsts[11].clCd06" class="i_radio clCd06" value="2" disabled="disabled"/>해당
            </div>
        </td>
    </tr>
    <tr style="display:none">
        ...
        <td colspan="3">
            <div class="form_group">
	            <input type="radio" name="rvRsts[11].clCd07" class="i_radio clCd07 value="1" disabled="disabled"/>해당없음
	            <input type="radio" name="rvRsts[11].clCd07" class="i_radio clCd07" value="2" disabled="disabled"/>수행필요
            </div>
        </td>
    </tr>
    <tr style="display:none">
        ...
        <td colspan="3">
            <div class="form_group">
	            <input type="radio" name="rvRsts[11].clCd08" class="i_radio clCd08" value="1" disabled="disabled"/>해당없음
	            <input type="radio" name="rvRsts[11].clCd08" class="i_radio clCd08" value="2" disabled="disabled"/>해당
            </div>
        </td>
    </tr>
    <tr style="display:none">
        ...
        <td colspan="3">
            <div class="form_group">
	            <input type="radio" name="rvRsts[11].clCd09" class="i_radio clCd09" value="1" disabled="disabled"/>해당없음
	            <input type="radio" name="rvRsts[11].clCd09" class="i_radio clCd09" value="2" disabled="disabled"/>수행필요
            </div>
        </td>
    </tr>
    <tr style="display:none">
        ...
        <td colspan="3">
            <div class="form_group">
	            <input type="radio" name="rvRsts[11].clCd10" class="i_radio clCd10" value="1" disabled="disabled"/>해당없음
	            <input type="radio" name="rvRsts[11].clCd10" class="i_radio clCd10" value="2" disabled="disabled"/>해당
            </div>
        </td>
    </tr>
    <tr style="display:none">
        ...
        <td colspan="3">
            <div class="form_group">
	            <input type="radio" name="rvRsts[11].clCd11" class="i_radio clCd11" value="1" disabled="disabled"/>해당없음
	            <input type="radio" name="rvRsts[11].clCd11" class="i_radio clCd11" value="2" disabled="disabled"/>수행필요
            </div>
        </td>
    </tr>
    <tr style="display:none">
        ...
        <td colspan="3">
            <div class="form_group">
	            <input type="radio" name="rvRsts[11].clCd12" class="i_radio clCd12" value="1" disabled="disabled"/>해당없음
	            <input type="radio" name="rvRsts[11].clCd12" class="i_radio clCd12" value="2" disabled="disabled"/>해당
            </div>
        </td>
    </tr>
    ...
    <tr style="display:none">
        ...
        <td colspan="3">
            <div class="form_group">
            <input type="text" name="rvRsts[11].clCmt05" class="i_input_full clCmt05" value="" disabled="disabled"/>
            </div>
        </td>
    </tr>
    <tr style="display:none">
        ...
        <td colspan="3">
            ...
            <textarea name="rvRsts[11].totRvSugg" class="i_text_full totRvSugg" rows="" cols="" disabled="disabled"></textarea>
            </c:if>
            <c:if test="${modeClass!='DAA'}">
                <pre class="totRvSuggText"><c:out value="${techReview.totRvSugg1}"/></pre>
            </c:if>
...
<%-- <table class="table_row" border="1" cellspacing="0">
    ...
    <tr>
        ...
        <td>
            <div class="form_group">
            <input type="radio" class="hazopActYn" name="hazopActYn" value="Y" <c:if test="${jobsReview.hazopActYn=='Y'}">checked </c:if> <c:if test="${modeClass!='JAA' || subModeClass!='S-ALA'}">disabled="disabled"</c:if>> 필요
            <input type="radio" class="hazopActYn" name="hazopActYn" value="N" <c:if test="${jobsReview.hazopActYn=='N'}">checked </c:if> <c:if test="${modeClass!='JAA' || subModeClass!='S-ALA'}">disabled="disabled"</c:if>> 불필요
        ...
        <td>
            <div class="form_group">
            <input type="radio" class="porcActYn" name="porcActYn" value="Y" <c:if test="${jobsReview.porcActYn=='Y'}">checked </c:if> <c:if test="${modeClass!='JAA' || subModeClass!='S-ALA'}">disabled="disabled"</c:if>> 필요
            <input type="radio" class="porcActYn" name="porcActYn" value="N" <c:if test="${jobsReview.porcActYn=='N'}">checked </c:if> <c:if test="${modeClass!='JAA' || subModeClass!='S-ALA'}">disabled="disabled"</c:if>> 불필요
...
// yoo 240823 직무검토(1)이 생성되면서 추가
    ...
    if("${modeClass}"=="JAA" && "${jobsReview.loginEmpNo}"=="${job.chrgEmpNo}") {
    ...
    $(".appReq").click(function () {
        if(confirm("초기 투자비 산정 요청 하시겠습니까?")) {
            $.removeComma();
            $('#pageLoadingWrap').show();
            $("form").attr("action", "mrTechAppReq2.do").submit();
        }
    });
    ...
    $(".app").click(function () {
        ...
        if(confirm("완료 하시겠습니까?")) {
            $('#pageLoadingWrap').show();
            $("form").attr("action", "mrJobsAppReq.do").submit();			// mrJobsAppReq.do
        }
    });
...
$.sortEmpLine = function(){
	...
	$("#empLine").children("tbody").children("tr").each(function () {
		...
		empDiv.find(".empValue").attr("name","jobs["+count+"].chrgEmpNo");
		empDiv.find(".empCode").attr("name","jobs["+count+"].chrgrClCd");
		empDiv.find(".empDuty").attr("name","jobs["+count+"].thdayPos");
		empDiv.find(".empTeam").attr("name","jobs["+count+"].thdayTeam");
		empDiv.find(".empTeamValue").attr("name","jobs["+count+"].chrgTeamNo");
